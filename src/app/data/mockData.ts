...
export const mockTables: Table[] = [
  ...
  { id: '12', number: 12, status: 'Dolu', guests: 3, total: 621.50, waiter: 'Ahmet Yılmaz', time: '16:20', billNo: 'A-0006' },
];
...
export const mockBillItems: Record<string, BillItem[]> = {
  ...
  '12': [
    { id: 'b21', productId: 'p3', productName: 'Latte', quantity: 3, price: 60.00 },
    { id: 'b22', productId: 'p7', productName: 'Croissant', quantity: 3, price: 65.00 },
    { id: 'b23', productId: 'p9', productName: 'Tiramisu', quantity: 2, price: 95.00 },
  ],
};
