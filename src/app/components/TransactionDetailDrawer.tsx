...
interface TransactionDetailDrawerProps {
  ...
  onViewReceipt?: (transaction: TransactionDetail) => void;
  onPrint?: (transaction: TransactionDetail) => void;
  onShare?: (transaction: TransactionDetail) => void;
  onStartRefund?: (transaction: TransactionDetail) => void;
}
...
export function TransactionDetailDrawer({
  ...
  const getStatusConfig = (status: string) => {
    switch (status) {
      ...
      case 'cancelled':
        return { label: 'İptal Edildi', color: 'bg-gray-100 text-gray-700 border-gray-200', icon: XCircle };
      default:
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="bg-white rounded-xl border border-gray-200 divide-y divide-gray-200">
              <div className="p-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="text-xs text-gray-600">İşlem Tipi</div>
                      <div className="text-sm font-semibold text-gray-900">{transaction.transactionType}</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="text-xs text-gray-600">Ödeme Tipi</div>
                      <div className="text-sm font-semibold text-gray-900">{transaction.paymentType}</div>
                    </div>
                  </div>
              ...
              {transaction.bankReference && (
                <div className="p-4 bg-gray-50">
                  ...
                  <div className="space-y-2">
                    ...
                    {transaction.originalReferenceNo && (
                      <div className="flex justify-between">
                        <span className="text-xs text-gray-600">Orijinal Referans:</span>
                        <span className="text-xs font-mono font-semibold text-gray-900">{transaction.originalReferenceNo}</span>
                      </div>
                    )}
                  </div>
                </div>
              ...
              {(transaction.refundReason || transaction.notes) && (
                <div className="p-4 bg-gray-50">
                  <h3 className="text-sm font-semibold text-gray-900 mb-3">İşlem Notları</h3>
                  <div className="space-y-2">
                    {transaction.refundReason && (
                      <div>
                        <div className="text-xs text-gray-600">İade Nedeni</div>
                        <div className="text-sm font-semibold text-gray-900">{transaction.refundReason}</div>
                      </div>
                    )}
                    {transaction.notes && (
                      <div>
                        <div className="text-xs text-gray-600">Açıklama</div>
